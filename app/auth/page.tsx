      ...
      <div className="max-w-md w-full mx-auto px-4 sm:px-6 lg:px-8">
        <div className="border border-gold-500/30 bg-white rounded-lg p-8 text-center shadow-lg">
          ...
          <button
            ...
            className="w-full bg-gold-500 text-neutral-900 px-6 py-4 font-semibold hover:bg-gold-400 transition-all rounded-md shadow-md hover:shadow-lg flex items-center justify-center gap-3"
          >
