-- ============================================
-- MAGANHA BARBEARIA - SETUP COMPLETO DO BANCO DE DADOS
-- ============================================
...
-- Serviços
INSERT INTO servicos (id, nome, descricao, duracao_minutos, preco, preco_original, desconto, itens_inclusos, observacoes, ordem) VALUES
  ('00000000-0000-0000-0000-000000000001', 'Completo (Corte, Barba, Sobrancelhas)', 'Destinado para quem quer fazer todos os serviços oferecidos aqui na Barbearia', 80, 78.00, 95.00, 18, ARRAY['Corte de cabelo (Somente adultos e crianças acima de 5 anos) - 40 min', 'Barba - 30 min', 'Sobrancelhas - 10 min'], NULL, 1),
  ('00000000-0000-0000-0000-000000000002', 'Corte de cabelo', 'Um dos requisitos mais importantes em uma imagem, com toda certeza é o cabelo, pois com o cabelo, você consegue "deixar" de ser uma pessoa e passa a "ser" outra pessoa, trazendo mais confiança para si mesmo e melhorando a forma como até mesmo as pessoas enxergam você 😉 E vai por mim, com certeza é para melhor!!!', 40, 40.00, NULL, NULL, NULL, 'Somente adultos e crianças acima de 5 anos', 2),
